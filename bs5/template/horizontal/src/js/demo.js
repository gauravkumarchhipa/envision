...
$(function () {
  ...
  var $themePrimary = $("<li />", { style: "padding: 5px;" }).append(
    '<a href="javascript:void(0)" data-theme="theme-primary" style="display: block;vertical-align: middle;" class="bg-primary clearfix rounded w-100 h-100 mb-5" title="Theme primary">' +
      "</a>"
  );
  $skinsList.append($themePrimary);

  var $themeInfo = $("<li />", { style: "padding: 5px;" }).append(
    '<a href="javascript:void(0)" data-theme="theme-info" style="display: block;vertical-align: middle;" class="bg-info clearfix rounded w-100 h-100 mb-5" title="Theme info">' +
      "</a>"
  );
  $skinsList.append($themeInfo);

  var $themeSuccess = $("<li />", { style: "padding: 5px;" }).append(
    '<a href="javascript:void(0)" data-theme="theme-success" style="display: block;vertical-align: middle;" class="bg-success clearfix rounded w-100 h-100 mb-5" title="Theme success">' +
      "</a>"
  );
  $skinsList.append($themeSuccess);

  var $themeDanger = $("<li />", { style: "padding: 5px;" }).append(
    '<a href="javascript:void(0)" data-theme="theme-danger" style="display: block;vertical-align: middle;" class="bg-danger clearfix rounded w-100 h-100 mb-5" title="Theme danger">' +
      "</a>"
  );
  $skinsList.append($themeDanger);

  var $themeWarning = $("<li />", { style: "padding: 5px;" }).append(
    '<a href="javascript:void(0)" data-theme="theme-warning" style="display: block;vertical-align: middle;" class="bg-warning clearfix rounded w-100 h-100 mb-5" title="Theme warning">' +
      "</a>"
  );
