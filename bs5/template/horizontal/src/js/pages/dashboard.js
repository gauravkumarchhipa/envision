$(function () {
  ...
  var userStatusBarChartOptions = {
    ...
    plotOptions: {
      bar: {
        ...
        columnWidth: "45%",
        borderRadius: 3,
        distributed: true, // per-bar colors
        dataLabels: {
          position: 'center' // labels inside the bars
        }
      },
    },
    dataLabels: {
      ...
      style: {
        fontSize: "12px",
        colors: ["#000000"], // black text for all numbers
        fontWeight: "bold"
      },
      offsetY: 0
    },
    colors: ["#28a745", "#6c757d"], // green for Active, gray for Inactive
    series: [
      {
        name: "Users",
        data: [12850, 3421],
  ...
  var analyticsBarChart = new ApexCharts(
    document.querySelector("#user_status_chart"),
    userStatusBarChartOptions
  );
...
var kioskStatusPieChartOptions = {
  chart: {
    height: 300,
    type: "pie",
  },
  series: [156, 12], // Values for Active and Inactive
...
var kioskStatusPieChart = new ApexCharts(
  document.querySelector("#kiosk_status_chart"),
  kioskStatusPieChartOptions
);

kioskStatusPieChart.render();

// Get the select element and the start and end date groups
const customSelect = document.getElementById("customSelect");
const startDateGroup = document.getElementById("startDateGroup");
const endDateGroup = document.getElementById("endDateGroup");

// Function to handle visibility of the date range inputs
function handleCustomRangeSelection() {
  if (customSelect.value === "5") {
...
customSelect.addEventListener("change", handleCustomRangeSelection);

// Initially set the visibility based on the selected option
